    ...
    <div class="col-md-7 ">
      <div class="">
          ...
          <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel">New Customer? Register with the field.</h4>
          </div>
                ...
                <div class="col-sm-12">
                  <div class="row">
                    <div class="col-sm-6 form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                      ...
                      <input type="text" name="first_name" placeholder="First Name" class="form-control"> @if ($errors->has('first_name'))
                    ...
                    <div class="col-sm-6 form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                      ...
                      <input type="text" name="last_name" placeholder="Last Name" class="form-control"> @if ($errors->has('last_name'))
                      <span class="help-block">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="phone_number" placeholder="Phone Number" class="form-control"> @if ($errors->has('phone_number'))
                        <span class="help-block">
                  ...
                  <div class="form-group{{ $errors->has('hold_name') ? ' has-error' : '' }}">
                    ...
                    <input type="text" name="hold_name" placeholder="e.g. Anis Mansion" class="form-control"> @if ($errors->has('hold_name'))
                    <span class="help-block">
                  ...
                  <div class="row">
                    <div class="col-sm-4 form-group{{ $errors->has('hold_no') ? ' has-error' : '' }}">
                      ...
                      <input type="text" name="hold_no" placeholder="e.g. 20" class="form-control"> @if ($errors->has('hold_no'))
                      <span class="help-block">
                    ...
                    <div class="col-sm-4 form-group{{ $errors->has('road_no') ? ' has-error' : '' }}">
                      ...
                      <input type="text" name="road_no" placeholder="e.g. 4" class="form-control"> @if ($errors->has('road_no'))
                      <span class="help-block">
                    ...
                    <div class="col-sm-4 form-group{{ $errors->has('hold_area') ? ' has-error' : '' }}">
                      ...
                      <input type="text" name="hold_area" placeholder="e.g. Khulshi" class="form-control"> @if ($errors->has('hold_area'))
                      <span class="help-block">
